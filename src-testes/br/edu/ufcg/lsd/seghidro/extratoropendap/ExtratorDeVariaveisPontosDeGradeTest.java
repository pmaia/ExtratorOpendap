...
public class ExtratorDeVariaveisPontosDeGradeTest {
	...
	public void testExtracaoMM1() throws ExtratorOpendapException,
		...
		ncr = new ExtratorDeVariaveisPontosDeGrade(ds, variavelDeInteresse,
	...
	@Test
	public void testExtracaoMM1_2() throws ExtratorOpendapException,
			ParseException {
		dataFinal = formatadorDeDatas.parse("2020-05-16");
		Coordenadas coordLeft = new Coordenadas(-10.2, -36.2);
		Coordenadas coordRight = new Coordenadas(-1, -26);
		ncr = new ExtratorDeVariaveisPontosDeGrade(ds, dataInicial, dataFinal,
				variavelDeInteresse, coordLeft, coordRight);
		ncr.extraiValoresDeInteresse();
		System.out.println(ncr.getExtracoes());
	}

	@Test
	public void testExtracaoOpenDAPGDS_precip()
			throws ExtratorOpendapException, ParseException {
		ds = new DataSet(
				"dods://150.165.83.184:8080/dods/ufcg/tempo/brams/brams20km/2009-03-03-1200");
		System.out.println(ds.getDetalhes());
		variavelDeInteresse = "precip";
		Coordenadas coordLeft = new Coordenadas(-7.993957436359008,
				-35.85888671875);
		Coordenadas coordRight = new Coordenadas(-7.140554782450295,
				-34.60693359375);
		ncr = new ExtratorDeVariaveisPontosDeGrade(ds, variavelDeInteresse,
				coordLeft, coordRight);
		ncr.extraiValoresDeInteresse();
	...
	@Test
	public void testExtracaoOpenDAPGDS_tempc() throws ExtratorOpendapException,
			ParseException {
		ds = new DataSet(
				"dods://150.165.83.184:8080/dods/ufcg/tempo/brams/brams20km/2009-03-03-1200");
