...
public class ExtratorDeVariaveisInterpoladoTest {
	...
	ncr = new ExtratorDeVariaveisInterpolado(ds, arquivoDePontos, dataInicial, dataFinal, variavelDeInteresse, arquivoDeExtracoes);
	...
	for (int i = 0; i < extracoesEsperadas.size(); i++) {
	    ...
	    assertEquals(extracaoEsperada.getValor(), extracao.getValorConvertido(), TOLERANCIA);
	}
	...
	ncr = new ExtratorDeVariaveisInterpolado(ds, arquivoDePontos, variavelDeInteresse, arquivoDeExtracoes);
	ncr.setFatorDeConversao(getFatorDeConversao());
    ...
    @Test
    public void testExtracaoOpenDAPUnlimitedDataSet2() throws ExtratorOpendapException, ParseException {
	...
	DataSet ds = new DataSet(arquivoNetCDF,dataInicial,dataFinal);
	ncr = new ExtratorDeVariaveisInterpolado(ds, arquivoDePontos,dataInicial, dataFinal,variavelDeInteresse);
	ncr.setFatorDeConversao(getFatorDeConversao());
	ncr.extraiValoresDeInteresse();
