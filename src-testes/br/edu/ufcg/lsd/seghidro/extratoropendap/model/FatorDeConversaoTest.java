...
/**
 * The class <code>FatorDeConversaoTest</code> contains tests for the class <code>{@link FatorDeConversao}</code>.
 *
...
public class FatorDeConversaoTest {
	 ...
	 */
	@Test
	public void testFatorDeConversao_1()
		throws Exception {
		String unidadesAposConversao = "Graus Célsius";
		fatorDeConversao = new FatorDeConversao("self-273", unidadesAposConversao);
