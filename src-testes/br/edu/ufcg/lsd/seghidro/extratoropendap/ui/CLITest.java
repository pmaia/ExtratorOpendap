...
public class CLITest {
	...
	try {
	    urlDataSet = new URL("http://150.165.126.97:8080/thredds/dodsC/test/MIMR_SRB1_1_pr-change_2011-2030.nc");
	...
	String[] args = new String[] {
		"-d", urlDataSet.toExternalForm(),
		"-p", pointsFile.getAbsolutePath(),
		"-i", "2020-05-16",
		"-f", "2020-08-16", 
	...
	this.urlDataSet = new URL("http://200.129.31.2:8083/thredds/dodsC/funceme/rsm/psst/mar-2009/rsm-2009PER0404-10.cdf");
