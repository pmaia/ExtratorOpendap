...
public class ExtratorDeVariaveisTest {
	...
	public void testExtracaoMM1() throws ExtratorOpendapException,
		...
		ncr = new ExtratorDeVariaveis(ds, arquivoDePontos, dataInicial,
				dataFinal, variavelDeInteresse, arquivoDeExtracoes);
		...
		for (int i = 0; i < extracoesEsperadas.size(); i++) {
			...
			assertEquals(extracaoEsperada.getValor(), extracao.getValor(),
					TOLERANCIA);
		}
	...
	@Test
	public void testExtracaoMM1BB() throws ExtratorOpendapException,
			ParseException {
	...
	@Test
	public void testExtracaoMM1BB_2() throws ExtratorOpendapException,
			ParseException {
		dataFinal = formatadorDeDatas.parse("2020-05-16");
		ncr = new ExtratorDeVariaveis(ds, dataInicial, dataFinal,
				variavelDeInteresse);
		Coordenadas coordLeft = new Coordenadas(-10.2, -36.2);
		Coordenadas coordRight = new Coordenadas(-1, -26);
		ncr.extraiPontosDeGrade(coordLeft, coordRight);
	...
	public void testExtracaoOpenDAPGDS() throws ExtratorOpendapException {
		...
		ncr = new ExtratorDeVariaveis(ds, arquivoDePontos, variavelDeInteresse,
				arquivoDeExtracoes);
		ncr.setFatorDeConversao(getFatorDeConversao());
