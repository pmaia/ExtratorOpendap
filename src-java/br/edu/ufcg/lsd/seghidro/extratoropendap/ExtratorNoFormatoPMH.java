...
public class ExtratorNoFormatoPMH {
	...
	public ExtratorNoFormatoPMH(String arquivoNetCDF,String arquivoPontos,   
			String arquivoPmh) throws IOException, ExtratorOpendapException, ParseException {
	 ...
	 * @throws ParseException
	 */
	private void setUp() throws IOException, ExtratorOpendapException, ParseException {
	 ...
	 * @throws ParseException
	 */
	private void buscarDadosOpenDap() throws ExtratorOpendapException, ParseException {
		...
		this.dadosPmh = this.dadosPmh.substring(0, this.dadosPmh.indexOf(FIM_DE_LINHA, dadosPmh.length()-2));
...
//	public static void main(String[] args) throws IOException, ExtratorOpendapException, ParseException {
//		
//		ExtratorNoFormatoPMH efp = new ExtratorNoFormatoPMH("tests/MIMR_SRB1_1_pr-change_2011-2030.nc",
