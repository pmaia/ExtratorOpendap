...
public class NetcdfAPIUtil {
	 ...
	 * @return O valor único.
	 */
	public static Double readSingleValueAsDouble(VariableIF variable,
			int[] origem) {
	 ...
	 * @return O valor.
	 */
	public static Object readValue(VariableIF variable, int[] origem,
			int[] shape) {
		try {
			logger.debug("Origem: " + Arrays.toString(origem) + " " + "Shape: "
					+ Arrays.toString(shape));
			Object valor = variable.read(origem, shape).getIndexIterator()
					.next();
	 ...
	 * @return O valor.
	 */
	public static Float readAsFloat(VariableIF variable, int[] origem,
			int[] shape) {
	 ...
	 * @return O valor.
	 */
	public static Double readAsDouble(VariableIF variable, int[] origem,
			int[] shape) {
		Object readValue = readValue(variable, origem, shape);
