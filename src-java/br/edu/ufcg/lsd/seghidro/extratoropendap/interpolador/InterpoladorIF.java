...
public interface InterpoladorIF {
	 ...
	 * 
	 * @param dataSet
	 *            O dataset que contém os valores a serem interpolados.
	 * @param variavel
	 *            O nome da variável presente no Dataset da qual o valor será
	 *            interpolado. Se este valor for null, recupera da primeira e,
	 *            possivelmente única, variável presente em <tt>dataSet</tt>.
	 * @param coordenadas
	 ...
	 *             Caso <tt>dataSet</tt> não contenha a variável
	 *             <tt>variavel</tt> ou haja algum problema durante a
	 *             interpolação.
	 */
